...
// rousr-mod: 
const RsrManifestRegistrations = require('./RsrManifestRegistrations');

const criteria = {
    env: process.env.NODE_ENV
};

// rousr-mod: replacing register value with RsrManifestRegistrations
...
const manifest = {
    ...
    register: RsrManifestRegistrations.getManifestRegistrations()
};
...
// original frame 14 implementation for register:
// register: {
//     plugins: [
//         {
//             plugin: '@hapi/good',
